            ...
            child: Stack(
              ...
              children: [
                ...
                Container(
                  ...
                  child: const Icon(Icons.account_balance, color: AppColors.danger, size: 38),
                ),
              ],
            ),
          ),
          const SizedBox(height: 22),
          Text('GOVERNMENT ALERT', style: TextStyle(fontFamily: appFont, fontWeight: FontWeight.w800, fontSize: 13, letterSpacing: 1.4, color: Colors.white)),
          const SizedBox(height: 4),
          Text('Official emergency advisory', style: TextStyle(fontFamily: appFont, fontSize: 11.5, color: Colors.white.withValues(alpha: 0.75))),
